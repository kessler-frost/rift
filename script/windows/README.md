...
a configuration file for building a Rift installer.
...
* Run `cargo build` to ensure the installer uses the latest version of Rift.
...
```shell
.\script\windows\Output\Rift-Windows-Setup.exe
```
