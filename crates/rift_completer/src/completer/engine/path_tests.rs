...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        riftui_core::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        riftui_core::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = riftui_core::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
...
pub fn test_sorted_cd_directories_no_cdpath_matches_existing_behavior() {
    ...
    let from_cd = riftui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
    let from_default = riftui_core::r#async::block_on(sorted_directories_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
...
pub fn test_sorted_cd_directories_includes_cdpath_entries() {
    ...
    let displays: Vec<String> = riftui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
