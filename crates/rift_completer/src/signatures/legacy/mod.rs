...
impl CommandRegistry {
    ...
    fn new_with_embedded_signatures() -> Self {
        let registry = CommandRegistry::new(
            |command| {
                ...
                let signature = command_signatures::signature_by_name(command);
                log::debug!(
            ...
            command_signatures::dynamic_command_signature_data(),
        );

        Self::register_rift_signatures(&registry);
    ...
    fn register_rift_signatures(registry: &Self) {
        ...
        for channel in channels {
            ...
            let mut clap_cmd = rift_cli::Args::clap_command();
            let signature =
