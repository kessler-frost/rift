...
fn test_end_to_end() {
    ...
    use riftui_core::elements::Fill;
    use riftui_core::fonts::Cache as FontCache;
    use riftui_core::text_layout::LayoutCache;
    ...
    App::test((), |mut app| async move {
        let mut font_cache = FontCache::new(Box::new(riftui::platform::current::FontDB::new()));
