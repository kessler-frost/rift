...
/// Icon enum to be used within the app in place of the riftui_core::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WarpDrive => "bundled/svg/rift.svg",
            Icon::Warp => "bundled/svg/rift-drive.svg",
            Icon::WarpLogoLight => "bundled/svg/rift-logo-light.svg",
            ...
            Icon::Rifting0 => "bundled/svg/rift-loading-0.svg",
            Icon::Rifting1 => "bundled/svg/rift-loading-1.svg",
            Icon::Rifting2 => "bundled/svg/rift-loading-2.svg",
            Icon::Rifting3 => "bundled/svg/rift-loading-3.svg",
            Icon::Rifting4 => "bundled/svg/rift-loading-4.svg",
            Icon::Rifting5 => "bundled/svg/rift-loading-5.svg",
            Icon::Rifting6 => "bundled/svg/rift-loading-6.svg",
            Icon::Rifting7 => "bundled/svg/rift-loading-7.svg",
            Icon::Rifting8 => "bundled/svg/rift-loading-8.svg",
            Icon::Rifting9 => "bundled/svg/rift-loading-9.svg",
            Icon::Rifting10 => "bundled/svg/rift-loading-10.svg",
            Icon::Rifting11 => "bundled/svg/rift-loading-11.svg",
