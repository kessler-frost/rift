...
impl From<Fill> for riftui_core::elements::Fill {
    fn from(theme: Fill) -> Self {
        match theme {
            Fill::Solid(c) => riftui_core::elements::Fill::Solid(c),
            Fill::HorizontalGradient(g) => riftui_core::elements::Fill::Gradient {
                start: vec2f(0.0, 0.0),
                end: vec2f(1.0, 0.0),
                start_color: g.left,
                end_color: g.right,
            },
            Fill::VerticalGradient(g) => riftui_core::elements::Fill::Gradient {
                start: vec2f(0.0, 0.0),
                end: vec2f(0.0, 1.0),
                start_color: g.top,
                end_color: g.bottom,
