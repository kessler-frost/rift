...
pub enum Event {
    ...
    MouseMoved {
        ...
        cmd: bool,
        shift: bool,
        /// Whether this mouse event was initiated by the user or by Rift synthetically.
        /// We create such synthetic mouse events for certain behaviors behaviors within
        /// Rift, such as triggering the correct tab to be "hovered" when the user closes
        ...
        /// the old tab (closed) to the new tab (shifted). Certain elements within Rift,
    ...
    /// Gets fired when user drags a file or folder into Rift. Note that there could exist
