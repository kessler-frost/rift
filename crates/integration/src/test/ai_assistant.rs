...
use rift::integration_testing::view_getters::ai_assistant_panel_view;
use riftui_core::async_assert;

use super::new_builder;
use crate::Builder;

/// Checks if the Ask Rift AI keybinding works correctly when a block is selected.
/// This is a regression test: upstream issue WAR-6758.
pub fn test_ask_ai_keybinding_for_selected_block() -> Builder {
    new_builder()
