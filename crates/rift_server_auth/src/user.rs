...
use rift_graphql::queries::get_user::FirebaseProfile;
...
impl From<rift_graphql::queries::get_user::PrincipalType> for PrincipalType {
    fn from(value: rift_graphql::queries::get_user::PrincipalType) -> Self {
        use rift_graphql::queries::get_user::PrincipalType as GqlPrincipalType;
        match value {
...
impl TryFrom<rift_graphql::mutations::create_anonymous_user::AnonymousUserType>
    for AnonymousUserType
{
    type Error = anyhow::Error;
    fn try_from(
        value: rift_graphql::mutations::create_anonymous_user::AnonymousUserType,
    ) -> Result<Self, Self::Error> {
        match value {
            rift_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUser => Ok(AnonymousUserType::NativeClientAnonymousUser),
            rift_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUserFeatureGated => Ok(AnonymousUserType::NativeClientAnonymousUserFeatureGated),
            rift_graphql::mutations::create_anonymous_user::AnonymousUserType::WebClientAnonymousUser => Ok(AnonymousUserType::WebClientAnonymousUser),
            rift_graphql::mutations::create_anonymous_user::AnonymousUserType::Other(_) => {
...
impl TryFrom<rift_graphql::queries::get_user::AnonymousUserPersonalObjectLimits>
    for PersonalObjectLimits
{
    type Error = anyhow::Error;
    fn try_from(
        value: rift_graphql::queries::get_user::AnonymousUserPersonalObjectLimits,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
