...
fn keystroke_to_c0_control_code(
    ...
    lazy_static! {
        static ref KEYSTROKE_TO_C0_CODE: HashMap<&'static str, u8> = HashMap::from([
            ...
            // `ctrl-/` into a control byte for us, so it has to be mapped here. See upstream
            // warp GH#4620.
            ("/", C0::US),
        ]);
    }
...
/// which readline-style TUIs interpret as `backward-kill-word`. See upstream warp #11342.
