use rift_core::safe_info;
use riftui_core::keymap::Keystroke;
use riftui_core::{Entity, ModelContext, ModelHandle, ViewContext};
...
/// This struct is a wrapper around the VimFSA that turns it into a riftui_core::Entity. We want to keep
/// the VimFSA independent of our UI framework, so anything involving riftui should live here
/// instead.
#[derive(Default)]
pub struct VimModel {
    fsa: VimFSA,
