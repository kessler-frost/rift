...
pub const EMBED_BLOCK_MARKDOWN_LANG: &str = "rift-embedded-object";

pub const RUNNABLE_BLOCK_MARKDOWN_LANG: &str = "rift-runnable-command";
pub const CODE_BLOCK_DEFAULT_MARKDOWN_LANG: &str = "text";
pub const TABLE_BLOCK_MARKDOWN_LANG: &str = "rift-markdown-table";
