//! This module contains utilities for dealing with file/directory paths throughout Rift.
use std::borrow::Cow;
...
/// \return any override shell launch path, reading from the RIFT_SHELL_PATH variable.
pub fn rift_shell_path() -> Option<String> {
    // TODO(peter): we ought to tolerate non-Unicode paths here.
    env::var("RIFT_SHELL_PATH").ok()
}
...
/// https://github.com/the upstream repo-internal/pull/13955
...
/// ```
/// use std::path::Path;
/// use rift_util::path::common_path;
///
...
/// use rift_util::path::group_roots_by_common_ancestor;
///
