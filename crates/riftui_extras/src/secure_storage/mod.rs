...
/// A type alias for the concrete type stored within a riftui
/// app context, enabling usage such as:
///
/// ```
/// use riftui_core::{App, SingletonEntity};
/// use riftui_extras::secure_storage;
///
...
/// common scheme is reverse-DNS notation (e.g.: "dev.rift.Rift").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut riftui_core::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut riftui_core::AppContext) {
...
impl riftui_core::Entity for Model {
    type Event = ();
}

impl riftui_core::SingletonEntity for Model {}
...
impl AppContextExt for riftui_core::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
