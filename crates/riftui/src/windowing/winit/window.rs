...
pub(crate) struct WindowManager {
    ...
    /// We assume this won't change throughout the life of the Rift process.
...
/// to work around it. See: https://github.com/the upstream repo/issues/6120
...
fn create_window(
    ...
    #[cfg(windows)]
    {
        ...
        // https://github.com/the upstream repo/issues/8935
