...
/// winit events into riftui events.
#[derive(Default)]
struct State {
...
impl EventLoop {
    ...
    pub fn handle_event(&mut self, evt: Event<CustomEvent>, window_target: &ActiveEventLoop) {
        ...
        match evt {
            ...
            Event::WindowEvent {
                ...
                // one with a different scale factor resize the Rift window to an absurdly small
    ...
    fn convert_window_event(
        ...
        match evt {
            ...
            WindowEvent::KeyboardInput {
                ...
                // the appropriate Rift-side event (ModifierKeyChanged).
    ...
    fn handle_converted_warpui_event(
        ...
        // passing the event into riftui. Skip for touch events as drag_resize_window
        ...
        // If the app didn't handle the event, riftui might still want to do something
    ...
    ///
    /// Converts `SoftKeyboardInput` events into riftui `Event`s and dispatches
