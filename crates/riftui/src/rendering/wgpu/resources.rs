...
use riftui_core::rendering::{GPUBackend, GPUDeviceInfo, GPUDeviceType};
use thiserror::Error;
...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for riftui
/// to render properly.
...
/// riftui to render properly. Currently, we limit this to "Intel UHD Graphics 620", but we do have
...
/// (Vulkan llvmpipe) adapter that may not work properly with riftui.
