//! Memory-behavior repros for APP-4154 batch 1.C (riftui-platform-nsstring).
//!
...
use riftui_core::platform::menu::{MenuItem, MenuItemPropertyChanges};
    ...
    unsafe {
        ...
        for _ in 0..APPLY_CHANGES_ITERS {
            let changes = MenuItemPropertyChanges {
                name: Some("Rift Menu Item".to_string()),
