...
use riftui::elements::{Align, Container, Empty, Flex, MouseStateHandle, ParentElement};
...
/// Used to show a Rift-native modal dialog above a [`super::Workspace`]. The first button is [`ButtonVariant::Accent`].
