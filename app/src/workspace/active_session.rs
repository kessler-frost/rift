...
use riftui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Rift from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
