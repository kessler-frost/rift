...
const LEARN_MORE_URL: &str = "https://www.rift.dev/blog/multi-harness-cloud-agent-orchestration";
...
const FEATURE_ITEMS: &[FeatureItem] = &[
    ...
    FeatureItem {
        ...
        description: "Rift Agents will now orchestrate swarms of subagents, allowing you to parallelize tasks.",
        badge: None,
    },
    FeatureItem {
        icon: Icon::Cognition,
...
impl OrchestrationLaunchModal {
    ...
    fn render_description(appearance: &Appearance) -> Box<dyn Element> {
        Text::new(
            "We've made major improvements to Rift's cloud agent orchestration platform, Oz.",
            appearance.ui_font_family(),
            14.,
        )
