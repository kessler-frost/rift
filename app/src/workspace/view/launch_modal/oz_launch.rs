    ...
    fn title(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::LaunchCredits => {
                "1,000 free cloud agent credits when you upgrade to Rift Build"
            }
        }
    }
    ...
    fn content(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::AgentManagement => {
                "View all of your agents across local and cloud sessions in the Rift app or at [oz.rift.dev](https://oz.rift.dev). Join live agent sessions, continue tasks locally, and steer agents with one click."
            }
            OzLaunchSlide::LaunchCredits => {
                "Upgrade to Build this month and receive 1,000 extra credits to try using Oz. Credits are only eligible for Oz runs in Rift-hosted cloud environments."
            }
        }
    }
