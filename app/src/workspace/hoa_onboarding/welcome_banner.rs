...
const FEATURE_ITEMS: &[FeatureItem] = &[
    ...
    FeatureItem {
        ...
        description: "Send inline comments from Rift's code review directly to Claude Code, Codex, or OpenCode",
    },
];
...
pub fn render_welcome_banner(
    ...
    // Title
    let title = Text::new(
        "Introducing universal agent support: level up any coding agent with Rift",
