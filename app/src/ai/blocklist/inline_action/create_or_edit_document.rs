...
use rift_core::ui::icons::Icon as CoreIcon;
use rift_core::ui::theme::color::internal_colors::neutral_2;
use riftui::elements::{
...
impl CreateOrEditDocumentAction {
    ...
    pub fn render(self, app: &AppContext) -> Box<dyn Element> {
        ...
        let content = Container::new(row.finish())
            ...
            .with_border(riftui::elements::Border::all(1.).with_border_fill(theme.surface_2()))
            .finish();
