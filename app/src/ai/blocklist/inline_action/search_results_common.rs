...
use riftui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: riftui::elements::MouseStateHandle,
    ...
    riftui::elements::Hoverable::new(mouse_state, |_| inner)
