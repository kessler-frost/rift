...
impl AIDocumentView {
                                ...
                                if state.is_hovered() {
                                    ...
                                    stack.add_positioned_overlay_child(
                                        ...
                                        OffsetPositioning::offset_from_parent(
                                            ...
                                            riftui::elements::ParentAnchor::BottomRight,
    ...
    pub fn bind_window(&self, window_id: riftui::WindowId, ctx: &mut ViewContext<Self>) {
...
impl View for AIDocumentView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn riftui::Element> {
        ...
        let editor = Container::new(ChildView::new(&self.editor).finish())
            ...
            .finish();
        content_column.add_child(riftui::elements::Expanded::new(1.0, editor).finish());
