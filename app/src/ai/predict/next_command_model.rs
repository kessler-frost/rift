...
use rift_completer::meta::Spanned;
use rift_completer::parsers::hir::{Command, Expression, FlagType};
use rift_completer::parsers::ParsedExpression;
...
cfg_if::cfg_if! {
    if #[cfg(feature = "local_fs")] {
        ...
        use rift_completer::parsers::hir::ArgType;
    }
}
...
pub fn is_next_command_enabled(app: &riftui::AppContext) -> bool {
