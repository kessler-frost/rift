...
pub fn todo_list_icon(appearance: &Appearance) -> riftui::elements::Icon {
...
pub fn pending_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Queued.into(),
...
pub fn in_progress_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Circle.into(),
...
pub fn succeeded_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Check.into(),
...
pub fn addressed_comment_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
...
pub fn failed_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Triangle.into(),
...
pub fn gray_stop_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
...
pub fn gray_clock_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
...
pub fn gray_circle_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Circle.into(),
        blended_colors::neutral_5(appearance.theme()),
    )
...
pub fn yellow_stop_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::StopFilled.into(),
...
pub fn yellow_running_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(
        Icon::Circle.into(),
        AnsiColorIdentifier::Yellow.to_ansi_color(&appearance.theme().terminal_colors().normal),
    )
...
pub fn red_stop_icon(appearance: &Appearance) -> riftui::elements::Icon {
    riftui::elements::Icon::new(Icon::StopFilled.into(), appearance.theme().ansi_fg_red())
}
