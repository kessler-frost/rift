...
use rift_core::ui::appearance::{Appearance, AppearanceEvent};
...
impl RuleView {
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            if is_selected {
                container = container
                    ...
                    .with_corner_radius(CornerRadius::with_all(riftui::elements::Radius::Pixels(
                        4.,
                    )));
    ...
    fn render_disabled_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        .with_corner_radius(CornerRadius::with_all(riftui::elements::Radius::Pixels(4.)))
