...
/// Flag to be passed to the rift executable when executing the rift binary as the plugin host
...
/// plugin host process.
const PLUGIN_HOST_ADDRESS_ENV_VAR: &str = "RIFT_PLUGIN_HOST_ADDRESS";
