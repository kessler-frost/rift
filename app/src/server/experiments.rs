...
impl Display for ServerExperiment {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let str = match self {
            ...
            Self::TmuxSshRiftificationControl => "TMUX_SSH_WARPIFICATION_CONTROL",
            Self::TmuxSshRiftificationExperiment => "TMUX_SSH_WARPIFICATION_EXPERIMENT",
...
impl ServerExperiment {
    ...
    pub fn from_string(s: String) -> Result<Self> {
        match s.as_str() {
            ...
            "TMUX_SSH_WARPIFICATION_CONTROL" => Ok(Self::TmuxSshRiftificationControl),
            "TMUX_SSH_WARPIFICATION_EXPERIMENT" => Ok(Self::TmuxSshRiftificationExperiment),
