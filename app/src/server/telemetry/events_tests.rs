use rift_core::telemetry::TelemetryEventDesc;
...
/// our [exhaustive telemetry table](https://the upstream docs/support-and-community/privacy-and-security/privacy#exhaustive-telemetry-table).
#[test]
#[cfg(not(target_family = "wasm"))]
fn telemetry_events_have_nonempty_name_and_description() -> Result<(), TelemetryEventPropertyError>
{
    for event in rift_core::telemetry::all_events() {
