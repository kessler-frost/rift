//! Logic relating to a secondary process which Rift uses to spawn new shell
//! sessions.
//!
...
//! early during Rift's initialization, we can be more confident that there are
...
pub fn run_terminal_server(args: &rift_cli::TerminalServerArgs) {
...
/// between processes, enabling the Rift application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(rift_cli::terminal_server_subcommand())
