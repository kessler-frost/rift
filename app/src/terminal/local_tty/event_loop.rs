    ...
    T: local_tty::EventedPty + Send + 'static,
{
    ...
    fn pty_read(
        ...
        loop {
            ...
            // Collect terminal response sequences (e.g. DA / cursor-position replies)
            // into a buffer queued on the write_list, rather than writing directly to the
            // PTY writer here — a blocking PTY write would otherwise silently drop them.
    ...
    pub fn spawn(mut self) -> JoinHandle<()> {
        #[cfg(test)]
        let feature_flag_overrides = rift_core::features::get_overrides();
        ...
        thread::Builder::new()
            ...
            .spawn(move || {
                ...
                #[cfg(test)]
                rift_core::features::set_overrides(feature_flag_overrides);
