use rift_completer::completer::{CommandOutput, GeneratorContext};
...
fn parse_dynamic_command(output: &CommandOutput) -> anyhow::Result<Vec<String>> {
    match output.status {
        rift_completer::completer::CommandExitStatus::Success => {
        ...
        rift_completer::completer::CommandExitStatus::Failure => {
