...
use riftui::{Element, Entity, SingletonEntity, TypedActionView, View, ViewContext};
...
impl FileUpload {
    ...
    /// Creates an sftp command that copies a given local file into the PWD of the riftified ssh session, if any.
