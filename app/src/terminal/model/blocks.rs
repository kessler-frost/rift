...
pub struct BlockList {
    ...
    /// to the PTY before rift_precmd is executed after the first command. `rift_precmd` is used
    ...
    fn seek_down_to_next_grid(
        ...
        match grid_type {
            GridType::Output => {
                ...
                // vs the next "command" (in the Rift prompt case), when using the combined grid, rather than
    ...
    fn clear_screen(&mut self, mode: ClearMode) {
        ...
        match mode {
            ...
            ClearMode::All => {
                ...
                // Rift's custom logic for "clear". It's not immediately straightforward because a
                ...
                // quite right with Rift's custom clear screen logic.
            }
            _ => {}
        }
