...
define_settings_group!(GeneralSettings, settings: [
    show_warning_before_quitting: ShowWarningBeforeQuitting {
        ...
        description: "Whether to show a warning dialog before quitting Rift.",
    },
    quit_on_last_window_closed: QuitOnLastWindowClosed {
        ...
        description: "Whether to quit Rift when the last window is closed.",
    },
    restore_session: RestoreSession {
        ...
        description: "Whether to restore the previous session when Rift starts up.",
    },
    add_app_as_login_item: LoginItem {
        ...
        description: "Whether to launch Rift automatically when you log in.",
    },
    ...
    open_in_rift_banner_dismissed_for_markdown: OpenInRiftBannerDismissedMarkdown {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    open_in_rift_banner_dismissed_for_code_and_text: OpenInRiftBannerDismissedCode {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
