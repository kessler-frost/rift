...
use riftui::elements::{ChildAnchor, OffsetPositioning, ParentAnchor, ParentOffsetBounds, Stack};
use riftui::keymap::Trigger;
use riftui::presenter::ChildView;
use riftui::{Action, Element, EventContext, TypedActionView, View, ViewContext, ViewHandle};
    ...
    V::Action: Clone + From<ContextMenuAction>,
{
    ...
    pub fn item_names<'a>(&self, ctx: &'a impl riftui::ViewAsRef) -> Vec<&'a str> {
        self.menu
            .as_ref(ctx)
            .items()
            .iter()
