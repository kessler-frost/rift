...
use crate::settings::session_mode::DefaultSessionMode;
...
pub(crate) fn render_action_sidecar(
    ...
    let button_style = UiComponentStyles {
        ...
        padding: Some(riftui::ui_components::components::Coords {
            top: 4.,
            bottom: 4.,
            left: 8.,
            right: 8.,
    ...
    let make_default_button = if is_already_default {
        ...
        appearance
            ...
            .on_click(move |ctx: &mut riftui::elements::EventContext, _, _| {
