...
use rift_core::ui::theme::{AnsiColorIdentifier, Fill as ThemeFill};
...
const RIFT_INDEXING_IGNORE_DESCRIPTION: &str = "To exclude specific files or directories from indexing, add them to the .warpindexingignore file in your repository directory. These files will still be accessible to AI features, but they won't be included in codebase embeddings.";
...
impl SettingsWidget for CodePageWidget {
    ...
    fn render(
        ...
        content.add_child(self.render_settings_subtext(
            global_ai_enabled,
            RIFT_INDEXING_IGNORE_DESCRIPTION,
            appearance,
        ));
...
impl CodePageWidget {
            ...
            let open_rules_button = ui_builder
                ...
                .with_text_and_icon_label(
                    riftui::ui_components::button::TextAndIcon::new(
                        ...
                        riftui::elements::MainAxisSize::Min,
                        riftui::elements::MainAxisAlignment::Center,
    ...
    fn render_lsp_server_row(
        ...
        workspace_path: &Path,
        server_type: LSPServerType,
        server_model: Option<&riftui::ModelHandle<LspServerModel>>,
        is_enabled: bool,
        mouse_states: LspServerRowMouseStates,
        appearance: &Appearance,
        app: &AppContext,
