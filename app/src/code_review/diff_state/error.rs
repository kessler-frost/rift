...
//!   through [`rift_core::report_error!`] or code-review telemetry keeps logs,
...
use rift_core::errors::{AnyhowErrorExt, ErrorExt};
use rift_core::sync_queue::IsTransientError;
...
rift_core::errors::register_error!(DiffStateError);
