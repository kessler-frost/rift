...
cfg_if::cfg_if! {
    if #[cfg(feature = "local_fs")] {
        ...
        use riftui::{ModelHandle, SingletonEntity};
    }
}
#[cfg(feature = "local_fs")]
...
impl LocalDiffStateModel {
        ...
        ctx.spawn_stream_local(
            ...
            |me, broadcast_result: Result<_, Arc<DiffStateError>>, ctx| {
                ...
                match broadcast_result {
                    ...
                    Err(err) => {
                        rift_core::report_error!(err.as_ref());
    ...
    #[cfg(not(feature = "local_fs"))]
    pub fn is_git_operation_blocked(&self, _app: &riftui::AppContext) -> bool {
        false
    }
    ...
    #[cfg(not(feature = "local_fs"))]
    fn active_repository_path(&self, _app: &riftui::AppContext) -> Option<PathBuf> {
        None
    }
    ...
    async fn num_lines_in_file_if_non_binary(file_path: &Path) -> Result<Option<usize>> {
        ...
        if rift_util::file_type::is_buffer_binary(&buffer) {
            return Ok(None);
        }
        file.rewind()?;
...
impl riftui::Entity for LocalDiffStateModel {
