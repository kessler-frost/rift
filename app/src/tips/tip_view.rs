    ...
    pub fn new(
        ...
        let tip_items = vec![
            TipItem::new(
                ...
                "Easily discover everything you can do in Rift without your hands leaving the keyboard.".to_string(),
            ...
            TipItem::new(
                ...
                "Make Rift your own by choosing a built-in theme. Or create your own.".to_string(),
