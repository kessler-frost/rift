...
pub fn initialize_settings_for_tests_with_mode(
    ...
    use crate::settings::{
        ...
        SameLinePromptBlockSettings, ScrollSettings, SelectionSettings, SessionModeSettings,
        SshSettings, ThemeSettings, VimBannerSettings, init_and_register_user_preferences,
    };
