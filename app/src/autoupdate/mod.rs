...
use riftui::windowing::{self, WindowManager};
use riftui::{AppContext, Entity, ModelContext, SingletonEntity, ViewContext};
    ...
    match autoupdate_stage {
        ...
        AutoupdateStage::UpdateReady {
            ...
            finalize_update(app, move |result, app| {
                ...
                let _event = TelemetryEvent::AutoupdateRelaunchAttempt {
