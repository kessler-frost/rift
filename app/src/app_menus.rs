...
const ENABLE_PTY_RECORDING: &str = "Enable PTY Recording Mode (rift.pty.recording)";
const DISABLE_PTY_RECORDING: &str = "Disable PTY Recording Mode (rift.pty.recording)";
...
const SETTINGS_CSV_FILE_NAME: &str = "rift_default_settings.csv";
...
fn make_new_help_menu() -> Menu {
    Menu::new(
        ...
        vec![
            feedback_menu_item(),
            link_menu_item("Rift Documentation...", links::USER_DOCS_URL.into()),
            link_menu_item("GitHub Issues...", links::GITHUB_ISSUES_URL.into()),
            link_menu_item("Rift Slack Community...", links::SLACK_URL.into()),
        ],
    )
}
...
/// Dispatch event to open a new Rift window
