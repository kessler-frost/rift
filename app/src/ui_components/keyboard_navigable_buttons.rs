...
pub type ButtonBuilder = Box<dyn Fn(bool, &riftui::AppContext) -> Button>;
...
impl KeyboardNavigableButtonBuilder {
    pub fn new(
        button_builder: impl Fn(bool, &riftui::AppContext) -> Button + 'static,
...
pub fn simple_navigation_button<A: riftui::Action + Clone + 'static>(
    text_label: String,
...
pub fn rich_navigation_button<A: riftui::Action + Clone + 'static>(
    text_label: String,
