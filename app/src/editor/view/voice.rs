...
use riftui::elements::{Container, CornerRadius, Icon, Radius};
use riftui::platform::Cursor;
use riftui::r#async::SpawnedFutureHandle;
use riftui::ui_components::button::ButtonTooltipPosition;
use riftui::ui_components::components::{Coords, UiComponent, UiComponentStyles};
use riftui::{elements, AppContext, Element, SingletonEntity, ViewContext, ViewHandle};
...
impl EditorView {
        ...
        ctx.subscribe_to_view(&voice_new_feature_popup, |_me, _, event, ctx| {
            if matches!(
                ...
                AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    rift_core::report_if_error!(settings
            ...
            voice_input::VoiceInputToggledFrom::Key { state } => {
                ...
                match &self.voice_input_state {
                    ...
                    VoiceInputState::Stopped => {
                        if matches!(state, riftui::event::KeyState::Released) {
                            return false;
                        }
                    }
                    ...
                    VoiceInputState::Listening => {
                        if matches!(state, riftui::event::KeyState::Pressed) {
                            return false;
                        }
                    }
                    _ => {}
    ...
    fn render_voice_transcription_button_tooltip(
        ...
        let mic_access_denied = matches!(
            ...
            riftui::platform::MicrophoneAccessState::Restricted
                | riftui::platform::MicrophoneAccessState::Denied
        );
    ...
    pub(super) fn render_voice_transcription_button(
        ...
        riftui::elements::SavePosition::new(
            button
                .build()
