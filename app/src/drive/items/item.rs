...
use riftui::presenter::PositionCache;
...
use crate::drive::panel::RIFT_DRIVE_POSITION_ID;
    ...
    fn default(appearance: &Appearance) -> WarpDriveItemStyles {
        ...
        WarpDriveItemStyles {
            ...
            dragged: UiComponentStyles::default()
                ...
                .set_background(
                    rift_core::ui::theme::color::internal_colors::fg_overlay_4(theme).into(),
                )
            ...
            hovered: UiComponentStyles::default()
                ...
                .set_background(
                    rift_core::ui::theme::color::internal_colors::fg_overlay_2(theme).into(),
                ),
        }
    }
}
...
fn drag_bounds_callback() -> impl Fn(&PositionCache, Vector2F) -> Option<RectF> {
    move |position_cache, window: Vector2F| {
        let drive_index = position_cache.get_position(RIFT_DRIVE_POSITION_ID)?;
